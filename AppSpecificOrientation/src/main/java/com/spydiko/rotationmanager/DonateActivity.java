...
public class DonateActivity extends PreferenceActivity implements Preference.OnPreferenceClickListener, AdListener, AdColonyAdListener { //
	...
	protected void onResume() {
		...
		if (appSpecificOrientation.LOG) Log.d(TAG, "onResume");
	}
	...
	protected void onCreate(Bundle savedInstanceState) { //
		...
		//                startAppAd = new StartAppAd(this);
		//                startAppAd.loadAd();
		appSpecificOrientation.configureAdColony(this);
	...
	public boolean onPreferenceClick(Preference preference) {
		if (connectivityManager.getActiveNetworkInfo() != null) {
			if ("appoftheday".equals(preference.getKey())) {
				...
				Intent browse = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=EDT5AU2ZJ6BX2"));
	...
	public void onReceiveAd(Ad ad) {
		if (AppSpecificOrientation.LOG) Log.d("OK", "Received ad");
	...
	public void onAdColonyAdAttemptFinished(AdColonyAd adColonyAd) {
		if (AppSpecificOrientation.LOG) Log.d(TAG, "onAdColonyAdAttemptFinished");
		//                adColonyVideoAd.show();
	...
	public void onAdColonyAdStarted(AdColonyAd adColonyAd) {
		if (AppSpecificOrientation.LOG) Log.d(TAG, "onAdColonyAdStarted");
	}
